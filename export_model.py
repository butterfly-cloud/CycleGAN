...
tf.flags.DEFINE_string('checkpoint_dir', './models/test', 'checkpoints directory path')
...
tf.flags.DEFINE_integer('image_size', 96, 'image size, default: 256')
tf.flags.DEFINE_integer('filters', 64,
...
def export_graph(model_name, XtoY=True):
  ...
  with graph.as_default():
    cycle_gan = CycleGAN(filters=FLAGS.filters, image_size=FLAGS.image_size)
